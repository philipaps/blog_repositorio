...
class Post(models.Model):
    titulo_post=models.CharField(max_length=255,verbose_name='Titulo')#verbose-name altera o nome nas abas-area admin-
    ...
    categoria_post=models.ForeignKey(Categoria,on_delete=models.DO_NOTHING,blank=True,null=True,verbose_name='Categoria')#não requerido, pode deixar sem categoria
    ...
    def __str__(self):
        return self.titulo_post #para poder retornar o label da categoria,comentario,etc
